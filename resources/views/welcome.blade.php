<x-layouts::guest>
    ...
    <section id="about"
        ...
        <div class="w-full max-w-4xl flex flex-col items-center justify-center h-[140px] md:h-[180px] select-none pointer-events-none overflow-hidden relative"
             style="contain: layout size;">

            <span class="text-[11px] text-zinc-500 tracking-widest uppercase mb-3 font-mono" data-scramble data-delay="0">[STEP 001]</span>

            <h1 class="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight text-white text-center w-full">
                <span class="block" data-scramble data-delay="150" data-glitch-loop="true">Software Engineer</span>
                <span class="text-zinc-400 block text-xl md:text-2xl my-1" data-scramble data-delay="50" data-glitch-loop="true">|</span>
                <span class="text-zinc-400 block" data-scramble data-delay="300" data-glitch-loop="true">Full-Stack Developer.</span>
            </h1>
        </div>
        ...
        <div id="terminal-window"
            ...
            <!-- Window Header -->
            <div class="border-b border-zinc-800 px-4 py-2.5 flex justify-between items-center bg-zinc-900/80 text-[11px] select-none">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 ml-2 text-zinc-500">
                        <button id="btn-minimize" title="Minimize" class="hover:text-white transition-colors focus:outline-none">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4" />
                            </svg>
                        </button>
                        <button id="btn-maximize" title="Maximize/Restore" class="hover:text-white transition-colors focus:outline-none">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <rect x="4" y="4" width="16" height="16" rx="1" stroke-width="2" />
                            </svg>
                        </button>
                        <button id="btn-close" title="Close Terminal" class="hover:text-red-400 transition-colors focus:outline-none">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Terminal Body -->
            <div id="terminal-body" class="p-6 text-sm md:text-base leading-relaxed font-mono space-y-4 max-h-[420px] overflow-y-auto transition-all duration-300 scrollbar-thin scrollbar-thumb-zinc-800">
                ...
                <div id="terminal-logs" class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-zinc-300 mt-1">
                            Yoga Wilanda — Berbasis di Surabaya, Indonesia. Berfokus pada pengembangan sistem web & mobile skala tinggi, arsitektur database multi-tenant, dan optimalisasi aplikasi custom tanpa rigid template.
                        </p>
